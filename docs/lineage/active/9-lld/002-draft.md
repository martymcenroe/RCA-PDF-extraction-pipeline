...
| `scripts/validators/__init__.py` | Add | Validators package init |
...
| `scripts/analysis/__init__.py` | Add | Analysis package init |
...
| `docs/0003-file-inventory.md` | Modify | Register new files |
...
# scripts/analysis/visualizations.py
...
* **Key Decisions:**
  - Modular validators for testability and reuse
...
|----------|-------------------|--------|-----------|
| Validation architecture | Monolithic / Modular validators | Modular validators | Easier testing, reusable components |
...
| Modular validators | Testable, reusable, clear separation | More files | **Selected** |
...
| Seaborn for visualization | Higher-level API | Extra dependency | **Rejected** |

**Rationale:** Modular architecture enables unit testing of individual validators while maintaining a simple CLI interface. Matplotlib provides publication-quality output without additional dependencies.

...
|------|-------------|-------------|
| `elementizer/__init__.py` | Modify | Register validation stage in pipeline |
| `elementizer/validation/__init__.py` | Add | Package initializer for validation module |
| `elementizer/validation/validators.py` | Add | Core validation functions (date, VIN, currency, mileage) |
| `elementizer/validation/schemas.py` | Add | Pydantic models for document type validation |
| `elementizer/validation/rules.py` | Add | Cross-field validation rule engine |
| `elementizer/validation/report.py` | Add | Validation report generation |
| `elementizer/validation/vin_decoder.py` | Add | VIN checksum and year decoding utilities |
| `elementizer/validation/stages/__init__.py` | Add | Pipeline stages subpackage initializer |
| `elementizer/validation/stages/validate.py` | Add | Pipeline stage integration |
...
- `elementizer/` directory exists (verified - parent for new validation module)
- `elementizer/__init__.py` exists (modified to register validation)
...
- Project root exists for `validation_rules.yaml` (no `config/` directory in repo)
- New directories (`elementizer/validation/`, `elementizer/validation/stages/`) will be created as part of file addition
...
```python
# elementizer/validation/validators.py
...
# elementizer/validation/vin_decoder.py
...
# elementizer/validation/rules.py
...
# elementizer/validation/stages/validate.py
...
# Run with coverage
poetry run pytest tests/unit/test_validators.py tests/unit/test_rules.py -v --cov=elementizer/validation --cov-report=term-missing

...
| `src/elementizer/validation/__init__.py` | Add | Package initializer for validation module |
| `src/elementizer/validation/validators.py` | Add | Core validation functions (date, VIN, currency, mileage) |
| `src/elementizer/validation/schemas.py` | Add | Pydantic models for document type validation |
| `src/elementizer/validation/rules.py` | Add | Cross-field validation rule engine |
| `src/elementizer/validation/report.py` | Add | Validation report generation |
| `src/elementizer/validation/vin_decoder.py` | Add | VIN checksum and year decoding utilities |
| `src/elementizer/validation/stages/__init__.py` | Add | Pipeline stages subpackage initializer |
| `src/elementizer/validation/stages/validate.py` | Add | Pipeline stage integration |
...
- `src/elementizer/` directory exists (verified - parent for new validation module)
...
- New directories (`src/elementizer/validation/`, `src/elementizer/validation/stages/`) will be created as part of file addition
...
```python
# src/elementizer/validation/validators.py
...
# src/elementizer/validation/vin_decoder.py
...
# src/elementizer/validation/rules.py
...
# src/elementizer/validation/stages/validate.py
...
* **Module:** `src/elementizer/validation/`
...
# Run with coverage
poetry run pytest tests/unit/test_validators.py tests/unit/test_rules.py -v --cov=src/elementizer/validation --cov-report=term-missing

...
| `tests/ingestion/fixtures/texas/__init__.py` | Add | Texas fixtures package init |
...
- `src/ingestion/` directory will be created with `__init__.py`
- `src/ingestion/modules/` directory will be created with `__init__.py`
- `tests/` directory exists at project root
- `tests/ingestion/` directory will be created with `__init__.py`
- `tests/ingestion/fixtures/` directory will be created with `__init__.py`
- `tests/ingestion/fixtures/texas/` directory will be created with `__init__.py`
...
5. `tests/ingestion/fixtures/texas/` with `__init__.py` and fixture files

...
- [x] Should `permeability_below_detection` be set TRUE when only one of air/klink is below detection, or both? — **Decision: TRUE if EITHER is below detection**
...
|--------|------|---------|-----------|
| Mechanical | - | REJECTED | Invalid file path: src/cli.py |

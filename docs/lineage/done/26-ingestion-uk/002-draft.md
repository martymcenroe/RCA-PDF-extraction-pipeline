...
2. Manifest with full metadata including quadrant, block, operator, spud date
3. Metrics tracking: downloaded, skipped, skip reasons
...
## Dependencies
- Core ingestion framework must be implemented (SourceModule base class, DownloadJob)

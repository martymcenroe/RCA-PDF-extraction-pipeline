...
## License Compliance
- **Volve Dataset:** Released under [Equinor Open Data License](https://www.equinor.com/energy/volve-data-sharing) — free for research, education, and commercial use with attribution
- **DISKOS Public Data:** Available under Norwegian Petroleum Directorate open data terms — verify specific license at implementation time
...
- `tests/fixtures/norway/` — Golden master HTML/JSON response fixtures
...
- Cloud/CI execution — local-only for initial implementation
...
Test cases:
- `test_volve_well_discovery` — Uses committed fixtures, verify all wells found
...
- `test_force_overwrite` — Existing files replaced when `--force` used

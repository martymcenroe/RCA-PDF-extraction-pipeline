...
- `src/extraction/csv_writer.py` — Add `sanitize_csv_value()` function for CSV injection prevention
- `tests/test_footnote_symbols.py` — New test file for symbol handling
- `tests/test_csv_sanitization.py` — New test file for CSV injection prevention

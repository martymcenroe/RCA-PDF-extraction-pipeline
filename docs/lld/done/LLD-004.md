...
ALLOWED_OUTPUT_ROOTS = [
    '/c/Users/mcwiz/Projects/pdf-table-extractor/data/output/',
...
cp /c/Users/mcwiz/Projects/pdf-table-extractor/data/output/spec/core_analysis.csv /tmp/baseline_before.csv

# === PHASE 2: RUN UNIT TESTS ===
poetry run --directory /c/Users/mcwiz/Projects/pdf-table-extractor-4 pytest tests/test_footnote_symbols.py -v

# === PHASE 3: GENERATE NEW OUTPUT ===
# Use the WORKTREE code to generate output
poetry run --directory /c/Users/mcwiz/Projects/pdf-table-extractor-4 python -m src.core_analysis /c/Users/mcwiz/Projects/pdf-table-extractor/data/output/spec/W20552.db --output /tmp/issue4 --original-headers
...
# diff /c/Users/mcwiz/Projects/pdf-table-extractor-4/data/output/spec/core_analysis.csv /tmp/issue4/core_analysis.csv
# echo $?  # MUST output 0
...
1. Create worktree: `git worktree add ../pdf-table-extractor-4 -b 4-footnote-symbols`
2. Push branch: `git -C ../pdf-table-extractor-4 push -u origin HEAD`
3. Install deps: `poetry install --directory ../pdf-table-extractor-4`
...
1. Run: `poetry run --directory ../pdf-table-extractor-4 python -m src.core_analysis data/output/spec/W20552.db --output /tmp/issue4 --original-headers`
...
1. If all checks pass, copy new output to baseline:
   ```bash
   cp /tmp/issue4/core_analysis.csv /c/Users/mcwiz/Projects/pdf-table-extractor-4/data/output/spec/core_analysis.csv
   ```

# 10015 - Feature: Rename Output Files to Match Specification Terminology

## 1. Context & Goal
* **Issue:** #15
* **Objective:** Rename output files to align with specification language ("Page Classification" and "Full Table Extraction") and separate bundled deliverables
* **Status:** Approved
* **Related Issues:** None
...
|--------|------|------|----------|
| Keep bundled JSON | No code change | Doesn't match specification | **Rejected** |
...
| Split and rename | Matches specification exactly | Requires JSON restructure | **Selected** |

**Rationale:** The specification explicitly describes two separate deliverables. Separating them makes evaluation straightforward.
...
| Reviewer expects old format | Med | Very Low | New format matches specification language |
